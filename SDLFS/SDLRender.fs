...
let fillRect (srcrect:Rectangle) (renderer:Renderer) =
    SDLGeometry.withSDLRectPointer(fun src ->SDLRenderNative.SDL_RenderFillRect(renderer.Pointer,src)) (Some srcrect)
